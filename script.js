const quizData = [
  ...
  },
  {
    ...
    options: [
      ...
      "Funciones globales solamente",
      "Sentencias sin estructura",
      "Macros y plantillas unicamente",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Nombre y apellido", "Compilador", "Servidor", "Memoria RAM"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "No existian compiladores",
      "No habia sistemas operativos",
      "No existian bases de datos",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Metodo", "Atributo", "Actor", "Problema"],
    answerIndex: 0,
    answerText: "Metodo.",
  },
  {
    ...
    options: ["Atributo", "Metodo", "Actor", "Proceso"],
    answerIndex: 0,
    answerText: "Atributo.",
  },
  {
  ...
  // --- NetBeans IDE ---
  {
    ...
    options: ["Apache NetBeans IDE", "Android Studio", "Visual Studio Code", "Eclipse"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["sc.nextLine()", "sc.nextInt()", "sc.read()", "sc.getText()"],
    answerIndex: 0,
  ...
  },
  {
    ...
    topic: "java",
    question: "En Java, el operador % representa:",
    options: ["Modulo (residuo)", "Division", "Multiplicacion", "Asignacion"],
    answerIndex: 0,
  ...
  },
  {
    ...
    topic: "java",
    question: "En Java, el operador * representa:",
    options: ["Multiplicacion", "Suma", "Division", "Modulo"],
    answerIndex: 0,
  ...
  },
  {
    ...
    topic: "java",
    question: "En Java, el operador / representa:",
    options: ["Division", "Multiplicacion", "Modulo", "Resta"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Quieres definir una clase",
      "Quieres importar un paquete",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Consulta, Diagnostico y Historial",
  ...
  },
  {
    ...
    options: [
      ...
      "Poca exactitud en el stock",
      "Falta de diagramas UML",
  ...
  },
  {
    ...
    options: [
      ...
      "Producto, Entrada y Salida",
      "Bodeguero, Administrador y Paciente",
      "Exactitud, Confidencialidad y Respaldo",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Comprar licencias y desplegar servidores",
  ...
  },
  {
    ...
    options: ["ArgoUML", "NetBeans Profiler", "Photoshop", "Excel"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Draw.io (diagrams.net)", "WordPad", "PowerPoint", "Notepad"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Funciones, no en objetos",
      "Variables globales",
      "Solo en la interfaz grafica",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Compilacion, Ejecucion y Depuracion",
      "Ventas, Marketing y Soporte",
      "Instalacion, Formateo y Backup",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Elegir el logo de la aplicacion",
      "Instalar el IDE",
      "Publicar el sistema en produccion",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Controlar el inventario de una bodega",
  ...
  },
  {
    ...
    options: [
      ...
      "Modelar relaciones",
      "Explicar el sistema en manuales",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Decidir la arquitectura general",
  ...
  },
  {
    ...
    options: [
      ...
      "Antes del analisis",
      "Durante la identificacion de clases",
      "Antes de documentar",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Correccion de errores (bugs)", "Dibujar casos de uso", "Elegir fuentes", "Instalar Java"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Refactorizacion", "Crear actores", "Definir objetos", "Hacer portada"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Javadoc / Comentarios", "Diagramas de red", "Tickets de soporte", "Backups"],
    answerIndex: 0,
  ...
  },
  {
    ...
    answerIndex: 0,
    answerText: "Analisis: comprender el problema.",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Identificacion: definir clases y objetos.",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Diseno: modelar relaciones.",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Implementacion: codificar (Java/Python).",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Pruebas: verificar funcionamiento.",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Mantenimiento: mejorar y corregir.",
  },
  {
    type: "mc",
    topic: "fases",
    ...
    answerIndex: 0,
    answerText: "Documentacion: explicar el sistema.",
  },
  ...
  // --- Introduccion a los pilares ---
  {
    ...
    options: [
      ...
      "Rapido, compacto y eficiente",
      "Funcional y declarativo",
      "Estatico y sin errores",
    ],
    answerIndex: 0,
  ...
  // --- Abstraccion ---
  {
    ...
    options: [
      ...
      "El mecanismo que agrupa datos y operaciones en una clase",
      "El proceso de herencia de propiedades",
      "La capacidad de ejecutar multiples acciones con una interfaz",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "'Como' funciona internamente el objeto",
  ...
  },
  {
    ...
    options: ["Caja Negra", "Caja Blanca", "Clase Abstracta", "Interfaz Publica"],
    answerIndex: 0,
  ...
  // --- Encapsulamiento ---
  {
    ...
    options: [
      ...
      "La capacidad de diferenciar propiedades externas e internas",
      "El proceso de adquirir propiedades de otro objeto",
      "La ejecucion de multiples metodos con una interfaz",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Los datos se copian a otra clase",
      "Los datos se hacen publicos",
    ],
    answerIndex: 0,
  ...
  // --- Herencia ---
  {
    ...
    options: [
      ...
      "Un objeto oculta sus datos internos",
      "Una operacion actua diferente segun el objeto",
      "Se diferencia entre propiedades externas e internas",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Generalizacion", "Especializacion", "Instancia", "Interfaz"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Especializacion", "Generalizacion", "Abstraccion", "Caja Negra"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Ejecutar multiples acciones con un nombre",
  ...
  // --- Polimorfismo ---
  {
    ...
    options: [
      ...
      "Un objeto oculte sus datos",
      "Una clase herede de otra",
      "Se diferencie entre propiedades externas e internas",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Se eliminan los metodos duplicados",
  ...
  },
  {
    ...
    options: ["Redes", "GUI basica", "Bases de datos", "Funciones basicas"],
    answerIndex: 0,
  ...
  // --- Control de Acceso: Visibilidad ---
  {
    ...
    options: [
      ...
      "Subclases y clases del mismo paquete",
      "Cualquier clase",
      "Solo clases abstractas",
    ],
    answerIndex: 0,
  ...
  // --- Problema: esquema procedimental ---
  {
    ...
    options: ["Minima", "Maxima", "Moderada", "Inexistente por diseno"],
    answerIndex: 0,
  ...
  // --- Getters y Setters ---
  {
    ...
    options: ["Puertas (Getters y Setters)", "Ventanas", "Constructores", "Interfaces"],
    answerIndex: 0,
  ...
  // --- Clase Empleado ---
  {
    ...
    answerIndex: 0,
    answerText: "private String cedula; private double sueldoXHora; = Estado (Privado).",
  },
  {
    type: "mc",
    topic: "encapsulamiento",
